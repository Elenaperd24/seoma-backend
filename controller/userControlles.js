    ...
    const mailOptions = {
        ...
        html:`<div  style="width: 400px; height: 200px; margin-left: 20%;">
            <div style="width: 100%; height:100%; background-color: #fff5ee;">
                  ...
                  <a href=https://app-seomaweb.herokuapp.com/api/verify/${uniqueString} style=" color: rgb(255, 85, 0); font-size: 20px;text-align: center; text-decoration: none;margin-left: 35%; font-weight: 700;">Click Here</a>
...
const userControllers = {
    ...
    verifyEmail: async (req, res) => {
        ...
        if (user) {
            ...
            await user.save()
            res.redirect("https://app-seomaweb.herokuapp.com/api/signin")
        }
        else {
